...
`--voice random` を指定すると、英語を含む以下の23言語からランダムに選ば
れます。
...
| ハンガリー語 | ○ | ○ | ラテン文字(Zalgo) |
| スウェーデン語 | ○ | ○ | ラテン文字(Zalgo) |
| 中国語(標準語) | ○ | ✕(下記参照) | ラテン文字(Zalgo) |
| 広東語 | ○ | ✕(音声データ無し) | ラテン文字(Zalgo) |
| フィンランド語 | ○ | ✕(音声データ無し) | ラテン文字(Zalgo) |
| アイスランド語 | ○ | ✕(音声データ無し) | ラテン文字(Zalgo) |
| ベトナム語 | ○ | ✕(音声データ無し) | ラテン文字(Zalgo) |
| ロシア語 | ○ | ✕(音声データ無し) | **キリル文字(実際の文字体系)** |
| ジョージア語 | ○ | ✕(音声データ無し) | **ジョージア文字(実際の文字体系)** |
| タイ語 | ○ | ✕(音声データ無し) | **タイ文字(実際の文字体系)** |
| アラビア語 | ○ | ✕(音声データ無し) | **アラビア文字(実際の文字体系)** |
| ヘブライ語 | ○ | ✕(音声データ無し) | **ヘブライ文字(実際の文字体系)** |
| アルメニア語 | ○ | ✕(音声データ無し) | **アルメニア文字(実際の文字体系)** |
| アムハラ語(エチオピア) | ○ | ✕(音声データ無し) | **エチオピア文字/ゲエズ文字(実際の文字体系)** |
| チェロキー語 | ○ | ✕(音声データ無し) | **チェロキー文字(実際の文字体系)** |
| ビルマ語(ミャンマー) | ○ | ✕(音声データ無し) | **ミャンマー文字(実際の文字体系)** |
| シンハラ語 | ○ | ✕(音声データ無し) | **シンハラ文字(実際の文字体系)** |
| タミル語 | ○ | ✕(音声データ無し) | **タミル文字(実際の文字体系)** |
| テルグ語 | ○ | ✕(音声データ無し) | **テルグ文字(実際の文字体系)** |
| ベンガル語 | ○ | ✕(音声データ無し) | **ベンガル文字(実際の文字体系)** |
